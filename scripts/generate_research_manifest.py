...
LATEST_METHOD_PAPERS = SEP14_METHOD_PAPERS + SEP16_METHOD_PAPERS + SEP16_FOLLOWUP_METHOD_PAPERS + (
    {
        ...
        "topic": ["持久化优化规划"], "first_author": "Kesheng Chen",
        "first_author_affiliation": "Harbin Institute of Technology, Shenzhen",
        "published": "2026-09-10", "code": "https://github.com/xin8coder/MAPLE",
        "adapter": "maple",
    },
    {
        "domain": "post-training", "key": "compass-opd",
        ...
        "topic": ["跨模型族 OPD"], "first_author": "Naibin Gu",
        "first_author_affiliation": "Institute of Information Engineering, Chinese Academy of Sciences",
        "published": "2026-09-09", "code": None, "adapter": "compass-opd",
    },
    {
        "domain": "agent-research", "key": "procedural-graphs",
        ...
        "topic": ["自进化程序图"], "first_author": "Yuxing Lu",
        "first_author_affiliation": "Google",
        "published": "2026-09-08", "code": None, "adapter": "procedural-graphs",
    },
    {
        "domain": "post-training", "key": "probe-erpo",
        ...
        "topic": ["代码测试时 RL"], "first_author": "Jiacheng Xu",
        "first_author_affiliation": "Nanyang Technological University",
        "published": "2026-09-08", "code": None, "adapter": "probe-erpo",
    },
    {
        "domain": "post-training", "key": "oprd",
        ...
        "topic": ["弱到强反向蒸馏"], "first_author": "Youngrok Park",
        "first_author_affiliation": "KAIST AI",
        "published": "2026-09-08", "code": None, "adapter": "oprd",
    },
    {
        "domain": "agent-research", "key": "feedback-scaffold",
        ...
        "topic": ["环境反馈脚手架"], "first_author": "Hongbang Yuan",
        "first_author_affiliation": "Fudan University",
        "published": "2026-09-08", "code": "https://github.com/HongbangYuan/EnvAsScaffold",
        "adapter": "feedback-scaffold",
    },
    {
        "domain": "post-training", "key": "route-opd",
        ...
        "topic": ["概率传输 OPD"], "first_author": "Tianle Xia",
        "first_author_affiliation": "Tencent",
        "published": "2026-09-08", "code": None, "adapter": "route-opd",
    },
    {
        "domain": "agent-research", "key": "memforest",
        ...
        "topic": ["事件树记忆压缩"], "first_author": "Junxi Wang",
        "first_author_affiliation": "Shanghai Jiao Tong University",
        "published": "2026-09-08", "code": "https://github.com/Celina-love-sweet/MemForest",
        "adapter": "memforest",
    },
    {
        "domain": "agent-research", "key": "atomrec",
        ...
        "topic": ["Agentic recommendation memory"], "first_author": "Peiyu Hu",
        "first_author_affiliation": "Xi'an Jiaotong-Liverpool University",
        "published": "2026-09-04", "code": None, "adapter": "atomrec",
    },
    {
        "domain": "agent-research", "key": "coskill",
        ...
        "topic": ["Hierarchical skill coevolution"], "first_author": "Jinyuan Feng",
        "first_author_affiliation": "Institute of Automation, Chinese Academy of Sciences",
        "published": "2026-09-04", "code": "https://github.com/jinyuan-cookie/CoSkill",
        "adapter": "coskill",
    },
    {
        "domain": "agent-research", "key": "silr",
        ...
        "topic": ["Structure-preserving verifier and reward"], "first_author": "Chenyu Zhou",
        "first_author_affiliation": "Institute of Science Tokyo",
        "published": "2026-09-03", "code": None, "adapter": "silr",
    },
    {
        "domain": "agent-research", "key": "multi-harness-rl",
        ...
        "topic": ["Multi-harness RL audit"], "first_author": "Chenqian Le",
        "first_author_affiliation": "New York University",
        "published": "2026-09-03", "code": None, "adapter": "multi-harness-rl",
    },
    {
        "domain": "post-training", "key": "sparse-opd",
        ...
        "topic": ["极稀疏 On-policy distillation"], "first_author": "Zhishuai Liu",
        "first_author_affiliation": "Amazon / Duke University",
        "published": "2026-09-03", "code": None, "adapter": "sparse-opd",
    },
    {
        "domain": "post-training", "key": "rlvr-fusion",
        ...
        "topic": ["跨领域 RLVR 能力融合"], "first_author": "Siye Wu",
        "first_author_affiliation": "Fudan University",
        "published": "2026-08-27", "code": "https://github.com/Di-viner/LLM-Fusion",
        "adapter": "rlvr-fusion",
    },
    {
        "domain": "post-training", "key": "video-opsd",
        ...
        "topic": ["证据帧特权自蒸馏"], "first_author": "Ziyue Wang",
        "first_author_affiliation": "Nanyang Technological University",
        "published": "2026-08-27", "code": None, "adapter": "video-opsd",
    },
    {
        "domain": "post-training", "key": "normalized-dpo",
        ...
        "topic": ["DPO 偏好/优化尺度解耦"], "first_author": "Ivan Kruzhilov",
        "first_author_affiliation": "Affiliation not listed in the paper",
        "published": "2026-08-27", "code": "https://github.com/ivankru/bayesian_dpo",
        "adapter": "normalized-dpo",
    },
    {
        "domain": "foundation-models", "key": "criticl",
        ...
        "topic": ["弱模型失败模式 ICL"], "first_author": "Yufan Wu",
        "first_author_affiliation": "The Ohio State University",
        "published": "2026-08-27", "code": None, "adapter": "criticl",
    },
    {
        "domain": "agent-research", "key": "redevoagent",
        ...
        "topic": ["红队技能进化"], "first_author": "Junjie Zhang",
        "first_author_affiliation": "City University of Hong Kong",
        "published": "2026-08-27", "code": None, "adapter": "redevoagent",
    },
    {
        "domain": "agent-research", "key": "ace-data",
        ...
        "topic": ["Agent 数据质量"], "first_author": "Xingshan Zeng",
        "first_author_affiliation": "Huawei Technologies Co., Ltd",
        "published": "2026-08-27", "code": None, "adapter": "ace-data",
    },
    {
        "domain": "agent-research", "key": "deeprepro",
        ...
        "topic": ["论文到代码状态子规划"], "first_author": "Hongru Song",
        "first_author_affiliation": "Institute of Computing Technology, Chinese Academy of Sciences",
        "published": "2026-08-27", "code": "https://github.com/ruyisy/DeepRepro",
        "adapter": "deeprepro",
    },
    {
