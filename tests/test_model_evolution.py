...
def test_implemented_agent_papers_have_composable_evolve_operators():
    ...
    assert agent_map["2112.09332"] == "tool:webgpt"
    assert agent_map["2204.01691"] == "planner:saycan"
    assert agent_map["2211.10435"] == "tool:pal"
    assert agent_map["2303.09014"] == "planner:art"
