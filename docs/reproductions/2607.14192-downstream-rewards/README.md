...
[![Downstream Rewards：模型无关的长期参与度优化 原论文 Figure 1](assets/paper-figure-01.png)](https://arxiv.org/html/2607.14192v2/figures/p2p_nhop_closeup_v2.png)

> **原论文 Figure 1（关键图）**：展示原论文方法的总体设计和关键组成。图片来自[原论文](https://arxiv.org/abs/2607.14192)，版权归原作者所有；点击图片可查看来源。
<!-- paper-figure:end -->
