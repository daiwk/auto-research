...
| 项目 | 内容 |
| --- | --- |
| 论文链接 | [arXiv 2601.02955](https://arxiv.org/abs/2601.02955) |
| 公司/机构 | Kuaishou Technology（按第一作者所属机构聚合） |
| 首次公开日期 | 2026-01-06（arXiv v1） |
| 原文开源代码 | 否：未找到原作者公开代码（核查日期：2026-09-05） |
| Adapter | `harmonrank` |
| 本地复现代码 | [`src/auto_research/reproductions/harmonrank/`](https://github.com/daiwk/auto-research/tree/main/src/auto_research/reproductions/harmonrank/) |
...
[![HarmonRank：排序一致的多目标集成 原论文 Figure 3](assets/paper-figure-01.png)](https://ar5iv.labs.arxiv.org/html/2601.02955/assets/analysis2.png)

> **原论文 Figure 3（关键图）**：展示原论文方法的总体设计和关键组成。图片来自[原论文](https://arxiv.org/abs/2601.02955)，版权归原作者所有；点击图片可查看来源。
<!-- paper-figure:end -->
