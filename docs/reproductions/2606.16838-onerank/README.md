# OneRank：原生统一 Transformer 多任务排序
...
| 项目 | 内容 |
| --- | --- |
| 论文链接 | [arXiv 2606.16838](https://arxiv.org/abs/2606.16838) |
| 公司/机构 | Renmin University of China（按第一作者所属机构聚合） |
| 首次公开日期 | 2026-06-15（arXiv v1） |
| 原文开源代码 | 否：论文未提供官方/作者代码（核查日期：2026-09-02） |
| Adapter | `onerank` |
| 本地复现代码 | [`src/auto_research/reproductions/onerank/`](https://github.com/daiwk/auto-research/tree/main/src/auto_research/reproductions/onerank/) |
...
[![OneRank：原生统一 Transformer 多任务排序 原论文 Figure 2](assets/paper-figure-01.png)](https://arxiv.org/html/2606.16838v1/overall.png)

> **原论文 Figure 2（关键图）**：展示原论文提出的核心架构、主要模块及其连接关系。图片来自[原论文](https://arxiv.org/abs/2606.16838)，版权归原作者所有；点击图片可查看来源。
<!-- paper-figure:end -->
