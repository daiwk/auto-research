...
[![MIM：多模态内容兴趣建模 原论文 Figure 2](assets/paper-figure-01.png)](https://ar5iv.labs.arxiv.org/html/2502.00321/assets/imgs/T1-Par_framework3.png)

> **原论文 Figure 2（关键图）**：展示原论文提出的核心架构、主要模块及其连接关系。图片来自[原论文](https://arxiv.org/abs/2502.00321)，版权归原作者所有；点击图片可查看来源。
<!-- paper-figure:end -->
