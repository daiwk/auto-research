...
## 本地复现
MovieLens-100K，180 users/280 items，80-step SFT；首轮 30-step DPO 退化 -13.27%，第二轮选择 10 steps、$\beta=0.1$。Hit@10 0.0611→0.0611，NDCG@10 0.02563→0.02643（**+3.10%**）。指标见 [`metrics/movielens-100k-seeds42-44.json`](metrics/movielens-100k-seeds42-44.json)。
