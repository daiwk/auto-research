...
| 项目 | 内容 |
| --- | --- |
| 论文链接 | [arXiv 2605.27103](https://arxiv.org/abs/2605.27103) |
| 公司/机构 | ByteDance（按第一作者所属机构聚合） |
| 首次公开日期 | 2026-05-26（arXiv v1） |
| 原文开源代码 | 否：未找到原作者公开代码（核查日期：2026-09-02） |
| Adapter | `muchator` |
| 本地复现代码 | [`src/auto_research/reproductions/muchator/`](https://github.com/daiwk/auto-research/tree/main/src/auto_research/reproductions/muchator/) |
...
[![MuChator：对话式音乐主动发现 原论文 Figure 2](assets/paper-figure-01.png)](https://arxiv.org/html/2605.27103v1/framework.png)

> **原论文 Figure 2（关键图）**：展示原论文提出的核心架构、主要模块及其连接关系。图片来自[原论文](https://arxiv.org/abs/2605.27103)，版权归原作者所有；点击图片可查看来源。
<!-- paper-figure:end -->
