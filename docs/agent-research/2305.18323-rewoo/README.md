...
[![ReWOO：把推理计划与工具观察解耦 原论文 Figure 1](assets/paper-figure-01.png)](https://ar5iv.labs.arxiv.org/html/2305.18323/assets/x1.png)

> **原论文 Figure 1（关键图）**：展示原论文的整体流程、关键阶段及其数据流向。图片来自[原论文](https://arxiv.org/abs/2305.18323)，版权归原作者所有；点击图片可查看来源。
<!-- paper-figure:end -->
