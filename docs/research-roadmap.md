...
更新基线：**2026-09-05**。8 月 31 日至 9 月 5 日四领域增量扫描完成 4 篇工业 P0 和
2 篇方法 P1，详见[扫描审计](recent-paper-scan-20260905.md)。Random Attention 与
Lngram v2 因真实 checkpoint/GPU 公平验证门槛进入下一独立批次。已登记的静态 P0/P1 队列均有终态；当前没有尚未实现的
