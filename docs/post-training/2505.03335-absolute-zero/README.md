...
| 字段 | 内容 |
|---|---|
| 论文链接 | [Absolute Zero：零人工数据的自生成课程（arXiv 2505.03335）](https://arxiv.org/abs/2505.03335) |
| 公司 / 机构 | Tsinghua University / LeapLab |
| 首次公开日期 | 2025-05-06（arXiv v1） |
| 原作者代码 | [已开源](https://github.com/LeapLabTHU/Absolute-Zero-Reasoner) |
...
[![Absolute Zero：零人工数据的自生成课程 原论文 Figure 4](assets/paper-figure-01.png)](https://ar5iv.labs.arxiv.org/html/2505.03335/assets/x3.png)

> **原论文 Figure 4（关键图）**：展示原论文的训练流程与关键优化环节。图片来自[原论文](https://arxiv.org/abs/2505.03335)，版权归原作者所有；点击图片可查看来源。
<!-- paper-figure:end -->
