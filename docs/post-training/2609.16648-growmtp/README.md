...
| 字段 | 内容 |
|---|---|
| 论文链接 | [GrowMTP: Can RL Grow Its Own Draft Head?](https://arxiv.org/abs/2609.16648) |
...
[![GrowMTP: Can RL Grow Its Own Draft Head? 原论文 Figure 2](assets/paper-figure-01.png)](https://arxiv.org/html/2609.16648v1/pipeline.png)

> **原论文 Figure 2（关键图）**：展示原论文的整体流程、关键阶段及其数据流向。图片来自[原论文](https://arxiv.org/abs/2609.16648)，版权归原作者所有；点击图片可查看来源。
<!-- paper-figure:end -->
