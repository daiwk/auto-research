...
| 字段 | 内容 |
|---|---|
| 论文链接 | [arXiv 2608.16072](https://arxiv.org/abs/2608.16072) |
| 公司 / 机构 | University of Florida |
| 第一作者 | Yixuan Wang |
| 首次公开日期 | 2026-08-17（arXiv v1） |
| 原作者代码 | 未发现原作者公开代码（截至 2026-08-24） |
| 本地 adapter / 方法 | `sa-mrpo` |
...
逐 reward 维度标准化优势，并依据 batch 饱和度动态把梯度预算转移到尚未掌握的目标。
...
[![Learn What's Left, Not What's Mastered: Saturation Aware Advantage Reweighting for Multi-Reward Policy Optimization 原论文 Figure 2](assets/paper-figure-01.png)](https://arxiv.org/html/2608.16072v1/gamma_sweep_smooth.png)

> **原论文 Figure 2（关键图）**：展示原论文的训练流程与关键优化环节。图片来自[原论文](https://arxiv.org/abs/2608.16072)，版权归原作者所有；点击图片可查看来源。
<!-- paper-figure:end -->

### 核心公式

$$
A=\sum_k(1-s_k)\frac{r_k-\mu_k}{\sigma_k+\epsilon}
$$

### 论文离线与线上效果

困难正确率在 15 项比较中赢 12 项；AIME24 最高 +5%，AMC23 +9.2%。 以上为原论文报告值；论文没有工业线上 A/B 时不作线上效果推断。
...
```bash
auto-research post-train --algorithm sa-mrpo --dataset arithmetic-smoke --steps 120 --seed 42 --no-network
```
