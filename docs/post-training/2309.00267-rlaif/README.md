...
| 字段 | 内容 |
|---|---|
| 论文链接 | [RLAIF：用 AI 偏好替代昂贵人工标注（arXiv 2309.00267）](https://arxiv.org/abs/2309.00267) |
...
[![RLAIF：用 AI 偏好替代昂贵人工标注 原论文 Figure 2](assets/paper-figure-01.png)](https://ar5iv.labs.arxiv.org/html/2309.00267/assets/x3.png)

> **原论文 Figure 2（关键图）**：展示原论文方法的总体设计和关键组成。图片来自[原论文](https://arxiv.org/abs/2309.00267)，版权归原作者所有；点击图片可查看来源。
<!-- paper-figure:end -->
