...
> **复现级别：L1 核心机制诊断。** 本地执行深度调度 reference kernel；未宣称论文 GPU 吞吐。

## 论文信息

| 字段 | 内容 |
|---|---|
| 论文链接 | [LoopSpec: Pipelined Self-Speculative Decoding for Looped Transformers](https://arxiv.org/abs/2609.17184) |
| 公司/机构 | Seoul National University / KAIST（按第一作者署名单位） |
...
[![LoopSpec: Pipelined Self-Speculative Decoding for Looped Transformers 原论文 Figure 1](assets/paper-figure-01.png)](https://arxiv.org/pdf/2609.17184#page=2)

> **原论文 Figure 1（关键图）**：展示原论文的整体流程、关键阶段及其数据流向。图片来自[原论文](https://arxiv.org/abs/2609.17184)，版权归原作者所有；点击图片可查看来源。
<!-- paper-figure:end -->
...
本地执行深度调度 reference kernel；未宣称论文 GPU 吞吐。
