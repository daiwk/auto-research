...
2026-09-27 的[四领域重叠扫描](recent-paper-scan-20260927.md)已恢复 arXiv 分页，
但 Google/Meta 官方发表页抓取失败；新的工业 P0 与跨领域 P1 全文复核队列已写入
[统一路线图](research-roadmap.md)，来源补查和逐项终态完成前不推进全来源 watermark。
