(() => {
  ...
  function card(item) {
    ...
    return `<article class="ar-dashboard-card">
      ...
      ${capability ? `<div class="ar-dashboard-card__evidence ar-dashboard-card__evidence--capability"><strong>L2 能力评测</strong><span>无 oracle · ${evidence.formal_comparison ? "三 seed 正式比较" : "非正式单次结果"}</span></div>` : ""}
