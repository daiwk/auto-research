...
def reproduce_mm_llm(dataset_dir: Path, seed: int = 42):
    ...
    return {
        ...
        "setup": {"users": len(data.train), "items": data.item_count, "steps": steps, "seeds": [seed, seed + 1, seed + 2]},
        "caption_training": caption_training, "training": training, "results": aggregate,
