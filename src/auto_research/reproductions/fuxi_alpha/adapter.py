...
ADAPTER = register(
    ReproductionAdapter(
        ...
        paper=PaperMetadata(
            ...
            online_ab=(
                OnlineABEvidence(
                    "Huawei Music", "songs played", 4.67, "30% traffic, 7 days"
                ),
                OnlineABEvidence(
                    "Huawei Music", "listening duration", 5.10, "30% traffic, 7 days"
                ),
            ),
        ),
        ...
        omitted_core_components=(
            "Huawei private features",
            "billion-parameter distributed training",
        ),
    )
)
