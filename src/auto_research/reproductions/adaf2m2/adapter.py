...
ADAPTER = register(ReproductionAdapter(
    ...
    paper=PaperMetadata(
        ...
        topics=("ranking", "feature-masking", "state-aware-adapter", "multi-forward"),
        online_ab=(
            OnlineABEvidence("Douyin", "cumulative active days", 1.37, "production A/B"),
    ...
    omitted_core_components=("Douyin private features", "production retrieval/ranking/cold-start stack"),
))
