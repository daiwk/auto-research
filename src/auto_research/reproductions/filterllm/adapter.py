...
ADAPTER = register(ReproductionAdapter(
    ...
    paper=PaperMetadata(
        ...
        topics=("llm-recommendation", "cold-start", "retrieval", "text-to-distribution"),
        online_ab=(
            OnlineABEvidence("Alibaba cold-start", "Cold-PV", 5.13, "two-month A/B"),
    ...
    omitted_core_components=("billion-user vocabulary", "proprietary LLM and cold-start traffic"),
))
