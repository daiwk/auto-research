...
ADAPTER=register(ReproductionAdapter(
    ...
    datasets=("SmolVLM2-256M-Video-Instruct checkpoint + deterministic RGB geometry probe",),baseline="same checkpoint without latent memory branch",metrics=("finite output","route diversity","sink selectivity","activation memory"),
