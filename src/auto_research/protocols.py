...
_PROTOCOLS = {
    item.protocol_id: item for item in (
        ...
        BenchmarkProtocol("foundation.banking77.system_one.v1", "foundation-model", "banking77",
                          "PolyAI-LDN/task-specific-datasets@master", "official train; official test split deterministically into validation/test",
                          "all 77 dynamic intent labels", "bilinear-cross-entropy",
                          "accuracy", True, (42, 43, 44), "matched-example-updates",
                          ("accuracy", "brier", "ece")),
