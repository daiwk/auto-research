...
后训练 demo 默认运行 Lightning OPD；可用同一 CLI 切换 DPO、GRPO、PPO-RLHF、
RLOO、ReMax、GPRL 或 TCR。Agent demo 可通过
`METHOD=react|reflexion|voyager|tree-of-thoughts|lats|toolformer
